  ...
  return (
    <div className='relative' ref={dropdownRef}>
      <button
        ...
        type='button'
      >
        {selected === 'list of products' ? 'Products' : selected}
        <RiArrowDropDownLine className='text-black' />
      </button>

      {toggle && !disabled && (
        <div
          className={`z-20 bg-white absolute w-full divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700`}
        >
          <ul
